...
public class JsonRequest<T> extends Request<T> {
     ...
     * @param errorListener
     */
    public JsonRequest(int method, String url, Class<T> clazz, Map<String, String> headers, Map<String, String> params,
     ...
     * @param errorListener
     */
    public JsonRequest(int method, String url, Class<T> clazz, Map<String, String> params, Response.Listener<T> listener,
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            LogUtils.i("volley response succcess->" + json);
            T obj = JSON.parseObject(json, clazz);//JsonParse.getInstance().getObjectFromJson(json, clazz);
            return Response.success(obj, HttpHeaderParser.parseCacheHeaders(response));
        } catch (Exception e) {
            e.printStackTrace();
            LogUtils.i("volley response error->" + JSON.toJSONString(new ParseError(e)));
